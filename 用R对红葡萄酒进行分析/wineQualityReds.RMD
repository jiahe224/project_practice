...
ggplot(wine_red,aes(quality, alcohol)) +
  geom_jitter( alpha = 0.3)  +
  geom_boxplot(aes(color=factor(quality)),alpha = 0.5) +
...
ggplot(aes(x=quality,y=volatile.acidity),data = wine_red) +
  geom_jitter(alpha=0.3) +
  geom_boxplot(aes(color=factor(quality)),alpha = 0.5) +
  geom_smooth(method = 'lm') +
